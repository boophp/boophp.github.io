...
class recover extends DCore_BackApp {
    ...
    public function main() {
        $topicDb = new DGroups_TopicDB(DGroups_Const::GROUP_PRODUCT_COMMON);
        $topicTitleDb = new DGroups_TopicTitleDB(DGroups_Const::GROUP_PRODUCT_COMMON);

        $apiTopic = new DApi_Topic(DGroups_Const::GROUP_PRODUCT_COMMON);
